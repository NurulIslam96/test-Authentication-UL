      ...
      <div className="max-w-md p-8 sm:flex sm:space-x-6 bg-gray-900 text-gray-100">
        ...
        <div className="flex flex-col space-y-4">
          <div>
            ...
            <span className="text-sm text-gray-400">Testing Purpose</span>
          </div>
          <div className="space-y-1">
            ...
            <span className="flex items-center space-x-2">
              ...
              <span className="text-gray-400">+{userInfo?.number}</span>
            </span>
            <span className="flex items-center space-x-2">
              <img src={icon} className="w-5" alt="" />
              <span className="text-gray-400">{userInfo?.address}</span>
            </span>
          </div>
            <label htmlFor="change-pass" className="btn btn-sm btn-outline btn-warning w-full">Change Password</label>
        </div>
      </div>
      <ChangePassModal/>
    </section>
